...
database.iloc[:rows_per_file].to_csv("movie_database1.csv", index=False)

# write the second output file
database.iloc[rows_per_file:2*rows_per_file].to_csv("movie_database2.csv", index=False)

# write the third output file
database.iloc[2*rows_per_file:].to_csv("movie_database3.csv", index=False)
